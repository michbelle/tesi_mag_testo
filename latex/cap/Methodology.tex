...
\begin{itemize}
	...
	\begin{itemize}
		\item As \texttt{controller\_plugins} use \texttt{nav2\_mppi\_controller::MPPIController}: a Model Predictive Path Integral (MPPI) algorithm to track a path with adaptive collision avoidance.
