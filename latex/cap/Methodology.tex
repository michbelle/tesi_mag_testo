...
\begin{itemize}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=1\linewidth]{img/comparazione_heading_with_yawVel.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{img/result_001_ekf.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{img/jobot_ekf_full.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{img/final_result_and_correction_XY.png}
...
\begin{figure}[H]
	...
	\captionof{figure}{Plots of the best result for the Jobot with record 001; on the left the correction along $x$, $y$ and for the $heading$; on the right the path followed by the robot}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{img/possible error caused by not good estimation.png}
	\captionof{figure}{Error when the estimation from AMCL fails}
	\label{error local and global costamp}
\end{figure}

\subsubsection{Jobot test results}

Since the odometry where better, this problem was not so much visible.
