...
In addiction, we updated the custom messages to ROS 2 that the Jobot uses internally.\\
...
\begin{figure}[H]
	...
	\captionof{figure}{Result performed by AMCL without translation correction}\label{fig:a1_amcl_stain_but_notlenght}
\end{figure}
...
Similar to the structure used in this paper\cite{10.1007/978-3-031-45770-8_29}, we create the services to start the communication with the sensor and, only after that they have been launched successfully, we launch the navigation stuck to control the UGVs.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/laser_high_error_Mini_Jobot.jpg}
