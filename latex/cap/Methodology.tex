...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0\linewidth]{img/amcl_jobot_best_plot.png}
...
Additionally, to start all nodes in the AMRs, systemd services are added.
...
\item An increment in the security is the setting up collision monitor for improve safety reason. This node use the information of some sensor and reduce the velocity sended to the robot in function of near obstacle.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/collision_monitor_graph.png}
	\captionof{figure}{Collision monitor diagram} 
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{img/polygon_check.png}
	\captionof{figure}{polygon display}
\end{figure}
\newpage
