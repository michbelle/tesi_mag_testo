...
Using that input we tried changing the value of the process noise covariance $Q$ tring to obtain the best result for the different records, this test were performed using the record 001 where the start position is inside the office and the end is outside the door of the office ( a distance of 3 m ) with a total length of about 187 m :

\begin{table}[h]
	\centering
	\begin{tabular}{|c|c|c|c|c|}
		\hline
		$v_x$ & $v_y$ & $v_{yaw}$ & record name & diff start end (m) \\
		\hline
...
\begin{figure}[h]
	...
	\captionof{figure}{Results record 005}
\end{figure}
...
\begin{itemize}
	...
	\item $\alpha 4$ : Expected process noise in odometry’s translation estimate from translation.
\end{itemize}
...
this test were performed on record 007 of the mini, the start position is about 
\begin{table}[H]
	\centering
	\begin{tabular}{|c|c|c|c|c|c|}
		...
		0 & 0 & 0 & 0 & 1.92 &  - \\
		\hline
		0.001 & 0 & 0 & 0 & 1.19 & 000 \\
		\hline
		0.01 & 0 & 0 & 0 & 1.15 & 001 \\
		\hline
		0.1 & 0 & 0 & 0 & 1.18 & 002 \\
		\hline
		0 & 0.001 & 0 & 0 & 1.11 & 003 \\
		\hline
		0 & 0.1 & 0 & 0 & 0.98 & 004 \\
		\hline
		0 & 0 & 0.001 & 0 & 2.07 & 005 \\
		\hline
		0 & 0 & 0.01 & 0 & 2.52 & 006 \\
		\hline
		0 & 0 & 0.1 & 0 & 3.31 & 007 \\
		...
		0 & 0 & 0 & 0.1 & 2.4  & 008 \\
		\hline
		0.01 & 0.01 & 0.01 & 0.0001 & 1.04 & 009 \\
		\hline
		0.01 & 0.01 & 0.1 & 0.0001 & 1.14 & 010 \\
		\hline
		0.01 & 0.0001 & 0.1 & 0.0001 & 2.82 & 011 \\
		\hline
	\end{tabular}
	\caption{result planner first request}
\end{table}

the first row is the data from odometry and nothing more.
