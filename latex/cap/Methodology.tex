...
\end{figure}
and so the acceleration from the IMU cannot be properly inserted because was adding a shifting to the position.\\
...
\begin{figure}[h]
	...
	\captionof{figure}{Mini odometry given by the robot (red) and odometry given by the \texttt{robot\_localization} package}
\end{figure}
